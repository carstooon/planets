...
class runge_kutta_4:
    ...
    def fInternal(planet_i, planet_j, d, t):
        ...
        grav_force_ij= Grav_const * planet_i.mass*planet_j.mass) * (planet_j.position[d]-planet_i.position[d]) / math.fabs(math.pow(math.sqrt(r2),3))
    ...
    def acceleration(i, d, t, planets):
        fInternal_tot = 0
        for planet_j in planets:
