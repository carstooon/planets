...
if __name__ == "__main__":
    ...
    sun          = planet.Planet(1.988544E+30, position_sun, velocity_sun, "Sun")
    ...
    planet_mercure   = planet.Planet(3.302E+23, position_mercure, velocity_mercure, "Mercure")
    ...
    planet_venus   = planet.Planet(4.8685E+24, position_venus, velocity_venus, "Venus")
    ...
    planet_earth   = planet.Planet(5.97219E+24, position_earth, velocity_earth, "Earth")
    ...
    planet_mars   = planet.Planet( 6.4185E+23, position_mars, velocity_mars, "Mars")
    ...
    planet_jupiter   = planet.Planet( 1.89813E+27, position_jupiter, velocity_jupiter, "Jupiter")
    ...
    planet_saturn   = planet.Planet(  5.68319E+26 , position_saturn, velocity_saturn, "Saturn")
    ...
    planet_uranus   = planet.Planet(8.68103E+25, position_uranus, velocity_uranus, "Uranus")
    ...
    planet_neptune   = planet.Planet( 1.0241E+26, position_neptune, velocity_neptune, "Neptune")

    sun_earth = [sun, planet_earth]
    solar_system = [sun, planet_mercure, planet_venus, planet_earth, planet_mars, planet_jupiter, planet_saturn, planet_uranus, planet_neptune]
    inner_solar_system = [sun, planet_mercure, planet_venus, planet_earth, planet_mars]
    outer_solar_system = [sun, planet_jupiter, planet_saturn, planet_uranus, planet_neptune]

    number_timesteps = 365
    delta_t = 1*24*60*60.

    sim = simulation.Simulation(inner_solar_system, number_timesteps, delta_t)
    sim.run_simulation()
    sim.save_dataframes()
    sim.print_energy()
    sim.print_position()
